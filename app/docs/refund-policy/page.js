        ...
        <div className="min-h-screen pb-24">
            <div className="relative overflow-hidden py-16 px-6">
                ...
                <div className="max-w-3xl mx-auto text-center relative">
                    <h1 className="font-heading font-bold text-3xl text-white mb-2">Refund Policy</h1>
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-8">
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">1. Refund Eligibility</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">2. Non-Refundable Items</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">3. How to Request a Refund</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">4. Refund Method</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
