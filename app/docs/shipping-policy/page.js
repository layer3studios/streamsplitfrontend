        ...
        <div className="min-h-screen pb-24">
            <div className="relative overflow-hidden py-16 px-6">
                ...
                <div className="max-w-3xl mx-auto text-center relative">
                    <h1 className="font-heading font-bold text-3xl text-[var(--text)] mb-2">Shipping &amp; Delivery Policy</h1>
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-8">
                <section>
                    <h2 className="font-heading font-semibold text-lg text-[var(--text)] mb-3">1. Digital Delivery</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-[var(--text)] mb-3">2. Delivery Timeframe</h2>
                    <ul className="list-disc list-inside text-[var(--muted)] text-sm leading-relaxed space-y-1 pl-2">
                        <li><strong className="text-[var(--text)]">Wallet top-ups:</strong> Instant after successful payment</li>
                        <li><strong className="text-[var(--text)]">Subscription plans:</strong> Activated within minutes to 24 hours of purchase</li>
                        <li><strong className="text-[var(--text)]">Group memberships:</strong> Immediate upon joining</li>
                    </ul>
                </section>

                <section>
                    <h2 className="font-heading font-semibold text-lg text-[var(--text)] mb-3">3. Delivery Confirmation</h2>
                    <p className="text-[var(--muted)] text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-[var(--text)] mb-3">4. Delivery Issues</h2>
                    <p className="text-[var(--muted)] text-sm leading-relaxed">
