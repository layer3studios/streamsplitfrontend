    ...
    return (
        <div className="min-h-screen pb-24">
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-8">
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">1. Acceptance of Terms</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">2. Account Registration</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">3. Subscription Sharing</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">4. Payments &amp; Wallet</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">5. Prohibited Conduct</h2>
                    <ul className="list-disc list-inside text-gray-400 text-sm leading-relaxed space-y-1 pl-2">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">6. Termination</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">7. Limitation of Liability</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
