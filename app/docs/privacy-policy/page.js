    ...
    return (
        <div className="min-h-screen pb-24">
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-8">
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">1. Information We Collect</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                        {BRAND.name} collects the following information when you use our platform:
                    </p>
                    <ul className="list-disc list-inside text-gray-400 text-sm leading-relaxed mt-2 space-y-1 pl-2">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">2. How We Use Your Information</h2>
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">3. Data Security</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">4. Data Sharing</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">5. Your Rights</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <section>
                    <h2 className="font-heading font-semibold text-lg text-white mb-3">6. Contact</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">
