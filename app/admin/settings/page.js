...
export default function AdminSettingsPage() {
    ...
    return (
        <div>
            <div className="mb-6">
                <h1 className="font-heading font-bold text-2xl text-white">Platform Settings</h1>
                <p className="text-gray-500 text-sm mt-1">Configuration loaded from <code className="text-gray-400">brand.config.js</code></p>
            </div>
            ...
            <div className="mt-6 p-4 border border-dashed border-dark-border rounded-xl text-center">
                <p className="text-gray-500 text-sm">
                    Settings are currently read-only. Edit <code className="text-gray-400">brand.config.js</code> to update platform configuration.
                </p>
            </div>
        </div>
    );
